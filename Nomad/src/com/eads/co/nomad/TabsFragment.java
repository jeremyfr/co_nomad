...
public class TabsFragment extends Fragment implements OnTabChangeListener {
	...
	private final TabDefinition[] TAB_DEFINITIONS = new TabDefinition[] {
			new SimpleTabDefinition(R.id.tab1, R.layout.simple_tab,
					R.string.tab_title_1, R.id.tabTitle, new Fragment()),
			new SimpleTabDefinition(R.id.tab2, R.layout.simple_tab,
					R.string.tab_title_2, R.id.tabTitle, new Fragment()),
			new SimpleTabDefinition(R.id.tab3, R.layout.simple_tab,
					R.string.tab_title_3, R.id.tabTitle, new Fragment()), };
